...
function printHeaderBanner() {
	if (screen.width > 981) {
		...
		$('#banner__head').html(`<div class="banner__mobile"> <div class="banner__logo-wrapper"> <img src="https://static.tildacdn.com/tild3961-3632-4065-b063-363339636238/Enscape_2020-09-09-1.jpg" alt="logo" class="banner__logo"> <p class="banner__desc">Качественные модели <br>для SketchUp</p></div></div>`);
	}
}
